    ...
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Form untuk mengedit data pekerjaan.</p>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Form Edit Pekerjaan</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('pages.pekerjaan.update', $pekerjaan->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" id="nama_pekerjaan" class="form-control @error('nama_pekerjaan') is-invalid @enderror" 
                                                name="nama_pekerjaan" value="{{ old('nama_pekerjaan', $pekerjaan->nama_pekerjaan) }}" placeholder="Masukkan nama pekerjaan" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="number" id="volume" class="form-control @error('volume') is-invalid @enderror" 
                                                name="volume" value="{{ old('volume', $pekerjaan->volume) }}" placeholder="Masukkan volume" step="any" required>
                                            @error('volume')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" id="satuan" class="form-control @error('satuan') is-invalid @enderror" 
                                                name="satuan" value="{{ old('satuan', $pekerjaan->satuan) }}" placeholder="Masukkan satuan" required>
                                            @error('satuan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" id="sumber_keterangan" class="form-control @error('sumber_keterangan') is-invalid @enderror" 
                                                name="sumber_keterangan" value="{{ old('sumber_keterangan', $pekerjaan->sumber_keterangan) }}" placeholder="Masukkan sumber keterangan" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" id="sub_unit" class="form-control @error('sub_unit') is-invalid @enderror" 
                                                name="sub_unit" value="{{ old('sub_unit', $pekerjaan->sub_unit) }}" placeholder="Masukkan sub unit" required>
                                            @error('sub_unit')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <select id="jenis_op" class="form-select @error('jenis_op') is-invalid @enderror" 
                                                ...
                                                <option value="" disabled>Pilih jenis OP</option>
                                                <option value="Investasi" {{ old('jenis_op', $pekerjaan->jenis_op) == 'Investasi' ? 'selected' : '' }}>Investasi</option>
                                                <option value="Operasional" {{ old('jenis_op', $pekerjaan->jenis_op) == 'Operasional' ? 'selected' : '' }}>Operasional</option>
                                            </select>
                                            @error('jenis_op')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="form-group position-relative">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" id="nilai_paket_pekerjaan" class="form-control @error('nilai_paket_pekerjaan') is-invalid @enderror" 
                                                    name="nilai_paket_pekerjaan" value="{{ old('nilai_paket_pekerjaan', $pekerjaan->nilai_paket_pekerjaan) }}" placeholder="Masukkan nilai paket" required>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="date" id="jadwal_mulai" class="form-control @error('jadwal_mulai') is-invalid @enderror" 
                                                name="jadwal_mulai" value="{{ old('jadwal_mulai', $pekerjaan->jadwal_mulai) }}" required>
                                            @error('jadwal_mulai')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="date" id="jadwal_selesai" class="form-control @error('jadwal_selesai') is-invalid @enderror" 
                                                name="jadwal_selesai" value="{{ old('jadwal_selesai', $pekerjaan->jadwal_selesai) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <select id="status_proses" class="form-select @error('status_proses') is-invalid @enderror" 
                                                ...
                                                <option value="" disabled>Pilih status proses</option>
                                                <option value="Belum Dimulai" {{ old('status_proses', $pekerjaan->status_proses) == 'Belum Dimulai' ? 'selected' : '' }}>Belum Dimulai</option>
                                                <option value="Dalam Proses" {{ old('status_proses', $pekerjaan->status_proses) == 'Dalam Proses' ? 'selected' : '' }}>Dalam Proses</option>
                                                <option value="Selesai" {{ old('status_proses', $pekerjaan->status_proses) == 'Selesai' ? 'selected' : '' }}>Selesai</option>
                                            </select>
                                            @error('status_proses')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <select id="status_gr" class="form-select @error('status_gr') is-invalid @enderror" 
                                                ...
                                                <option value="" disabled>Pilih status GR</option>
                                                <option value="Belum GR" {{ old('status_gr', $pekerjaan->status_gr) == 'Belum GR' ? 'selected' : '' }}>Belum GR</option>
                                                <option value="Sudah GR" {{ old('status_gr', $pekerjaan->status_gr) == 'Sudah GR' ? 'selected' : '' }}>Sudah GR</option>
                                            </select>
                                            @error('status_gr')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" id="jenis_investasi" class="form-control @error('jenis_investasi') is-invalid @enderror" 
                                                name="jenis_investasi" value="{{ old('jenis_investasi', $pekerjaan->jenis_investasi) }}" placeholder="Masukkan jenis investasi" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" id="div" class="form-control @error('div') is-invalid @enderror" 
                                                name="div" value="{{ old('div', $pekerjaan->div) }}" placeholder="Masukkan divisi" required>
                                            @error('div')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group position-relative">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" id="nilai_item_investasi" class="form-control @error('nilai_item_investasi') is-invalid @enderror" 
                                                    name="nilai_item_investasi" value="{{ old('nilai_item_investasi', $pekerjaan->nilai_item_investasi) }}" placeholder="Masukkan nilai item investasi" required>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group position-relative">
                                            ...
                                            <input type="text" id="pbj" class="form-control @error('pbj') is-invalid @enderror" 
                                                name="pbj" value="{{ old('pbj', $pekerjaan->pbj) }}" placeholder="Masukkan PBJ" required>
                                            @error('pbj')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
